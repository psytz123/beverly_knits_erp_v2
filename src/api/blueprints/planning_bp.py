            ...
            if phase_num == 1:  # Demand Planning
                ...
                if handler.data_loader:
                    ...
                    if yarn_data is not None:
                        ...
                        phase_result["metrics"]["shortage_items"] = (
                            len(yarn_data[yarn_data.get("Planning Balance", 0) < 0])
...
def emergency_shortage_dashboard():
    ...
    try:
        ...
        if emergency_data["alert_level"] == "RED":
            ...
            emergency_data["immediate_actions"] = ["Continue normal monitoring"]
    ...
    try:
        ...
        if validation_result["valid"]:
            validation_result["recommendation"] = (
                "Substitution approved with monitoring"
            )
        else:
