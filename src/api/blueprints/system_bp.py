...
def cache_stats():
    ...
    try:
        stats = {"cache_enabled": False, "stats": {}}
...
def reload_data():
    ...
    try:
        reload_status = {"timestamp": datetime.now().isoformat(), "reloaded": {}}
            ...
            if hasattr(handler.data_loader, "load_all_data"):
                ...
                for key, data in all_data.items():
                    if data is not None:
                        ...
                        reload_status["reloaded"][key] = {"success": False}
...
def consolidation_metrics():
    ...
    try:
        ...
        metrics["migration_progress"] = round(
            (migrated_endpoints / total_endpoints) * 100, 2
        )
...
def system_info():
    ...
    try:
        info = {
            ...
            "modules": {"services": [], "data_loaders": [], "blueprints": []},
        }
