...
class PODeliveryLoader:
    ...
    def calculate_total_on_order(
        self, weekly_deliveries: Dict[str, Dict[str, float]]
    ) -> Dict[str, float]:
        """
    ...
    def get_delivery_timeline(
        self, yarn_id: str, weekly_deliveries: Dict[str, Dict[str, float]]
    ) -> Dict[str, float]:
        """
    ...
    def export_time_phased_data(
        self, weekly_deliveries: Dict[str, Dict[str, float]], output_path: str
    ) -> bool:
        """
