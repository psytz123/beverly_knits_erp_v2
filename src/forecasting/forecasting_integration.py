...
class ForecastingIntegration:
    ...
    def __init__(
        ...
        self.validation_system = ForecastValidationSystem(
            accuracy_target=accuracy_target, confidence_level=0.95
        )
        ...
        logger.info(
            f"Enhanced Forecasting System initialized - Target: {accuracy_target*100}% at 9-week horizon"
        )
    ...
    def generate_forecast(
        self, yarn_id: str, include_orders: bool = True
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if (
                ...
                and not result.confidence_intervals.empty
            ):
            ...
            return {"error": str(e), "yarn_id": yarn_id, "status": "failed"}

    def generate_bulk_forecasts(
        self, yarn_ids: List[str], include_orders: bool = True
    ) -> Dict[str, Any]:
        """
    ...
    def get_forecast_status(self) -> Dict[str, Any]:
        ...
        status["accuracy"] = {
            "current_average": accuracy_report.get("overall_metrics", {}).get(
                "average_accuracy", 0
            ),
    ...
    def _load_yarn_orders(self, yarn_id: str) -> pd.DataFrame:
        ...
        try:
            ...
            return pd.DataFrame({"order_date": dates, "quantity": np.abs(quantities)})
...
def create_forecast_api(
    app: Flask, data_path: str = "/mnt/d/Agent-MCP-1-ddd/Agent-MCP-1-dd/ERP Data/5/"
):
    """
