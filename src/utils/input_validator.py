...
class InputValidator:
    ...
    @staticmethod
    def sanitize_string(
        text: str, max_length: int = 255, allow_special: bool = False
    ) -> str:
        """
    ...
    def validate_batch_size(
        size: int, min_size: int = 1, max_size: int = 10000
    ) -> bool:
        """
...
class RequestValidator:
    ...
    def validate_sort_params(
        request_args: Dict[str, Any], allowed_fields: List[str]
    ) -> Dict[str, str]:
        """
    ...
    def validate_filter_params(
        request_args: Dict[str, Any], allowed_filters: Dict[str, type]
    ) -> Dict[str, Any]:
        """
