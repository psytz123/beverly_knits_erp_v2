...
### [**gap-analyst**](gap-analyst.md) - Gap identification and completeness assessment
Gap analysis specialist identifying missing components and assessing system completeness. Masters requirements gap analysis, coverage assessment, and technical debt identification. Delivers comprehensive gap reports with prioritized remediation.

**Use when:** Identifying missing features, assessing test coverage gaps, finding documentation gaps, comparing current vs desired state, or evaluating system completeness.
...
| Identify gaps and missing components | **gap-analyst** |
...
- **gap-analyst** for gap identification
- **research-analyst** for comprehensive review
- **data-researcher** for coverage analysis
- **search-specialist** for missing information
