...
When invoked:
1. Initialize and verify agent state
...
4. Begin task processing only after successful initialization
...
PRE_INIT -> INITIALIZING -> READY -> ACTIVE -> SHUTDOWN
...
5. SHUTDOWN
   ...
   - Resource cleanup
   - Task handoff/completion
   - Connection cleanup

State Management:
```json
{
  "agent_id": "ai-engineer-{{timestamp}}",
  "state": "READY",
  "uptime_seconds": 120,
