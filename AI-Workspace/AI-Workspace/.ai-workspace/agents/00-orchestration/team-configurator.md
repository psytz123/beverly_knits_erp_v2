...
When invoked:
1. Read .agent-workspace/manifest.json for project metadata
2. Scan codebase to detect technology stack
3. Review available agents from system and project directories
4. Select optimal specialist agents for the detected stack
5. Create/update CLAUDE.md with AI Team Configuration section
6. Write configuration to .agent-workspace/outputs/documentation/
7. Update manifest.json with configured team
8. Create handoff documenting available specialists
