...
When invoked:
1. Read .agent-workspace/manifest.json (if exists) for project context
2. Scan project directory structure and configuration files
3. Detect technology stack, frameworks, and patterns
4. Create structured analysis report
5. Write report to .agent-workspace/outputs/analysis/
6. Update manifest.json with technology stack information
7. Create handoff for recommended specialist agents
